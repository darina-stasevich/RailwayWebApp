...
public class CustomTextSerializerTests
{
    private CustomTextSerializer _serializer;
    private string _testFilePath;
    
    [SetUp]
    public void Setup()
    {
        _serializer = new CustomTextSerializer();
    ...
    public void TestStationsSerializer()
    {
        ...
        _serializer.Serialize(stations, _testFilePath);

        var deserializedStations = _serializer.Deserialize<List<Station>>(_testFilePath);
    ...
    public void TicketSerializer()
    {
        ...
        _serializer.Serialize(ticket, _testFilePath);
        var deserializedTicket = _serializer.Deserialize<Ticket>(_testFilePath);
    ...
    public void AbstractRouteTest()
    {
        ...
        _serializer.Serialize(route, _testFilePath);
        var deserializedRoute = _serializer.Deserialize<AbstractRoute>(_testFilePath);
